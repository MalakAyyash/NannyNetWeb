...
function RequestOfferBooking() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get('http://176.119.254.188:8080/customer/offer/orders/pending', config);
...
export default RequestOfferBooking;
