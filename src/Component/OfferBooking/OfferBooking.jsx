    ...
    return (
        ...
        <div className='Cover d-flex align-items-center justify-content-start ps-3'>
          ...
          <ul className="nav  d-none d-md-flex">
            ...
            <li className={`nav-item`}>
            <RouterLink to={`/offerBookings/${customerData.user.id}`} className={`nav-link border-bottom`}>My Offer Bookings</RouterLink>
          </li>
            <li className={`nav-item`}>
      ...
      <hr />
            ...
            <div className='DetaliedBook mt-5 normalFont'>
                ...
                <div className='DetaliedBook mt-5'>
                    <div className=''>
                        <p className='pt-2 profileTitle'>Manage Your Offer Bookings</p>
                    </div>
                    <p className='small mb-5 profileDate'>Stay organized and in control of your schedule.</p>
                    <ul className="nav nav-tabs mb-5 ">

                    <li className="nav-item">
                            <a className={`nav-link text-dark ${activeTab === 'offers' ? 'active' : ''}`} onClick={() => setActiveTab('offers')} href="#">
                                My Offers
                            </a>
                        </li>
