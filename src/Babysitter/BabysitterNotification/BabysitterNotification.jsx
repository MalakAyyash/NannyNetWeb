...
function BabysitterNotifiction() {
          ...
          <div>
            ...
            {ownerProfile && (
                ...
                <RouterLink to={`/BabysitterFeedback/${babysitterData.user.id}`} className={`nav-link`}>Feedback</RouterLink>
                    ...
                    <li className={`nav-item`}>
                <RouterLink to={`/BabysitterNotification/${babysitterData.user.id}`} className={`nav-link border-bottom`}>Notification</RouterLink>
                </li>
...
export default BabysitterNotifiction;
