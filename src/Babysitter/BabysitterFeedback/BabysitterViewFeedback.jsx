...
function BabysitterViewFeedback() {
    ...
    useEffect(() => {
        const fetchFeedbackData = async () => {
            try {
                ...
                const response = await axios.get('http://176.119.254.188:8080/provider/feedback/getAll', config);
...
export default BabysitterViewFeedback;
