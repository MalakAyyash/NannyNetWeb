...
import NonOwnerFeedbackComponent from './NonOwnerFeedbackComponent'; // Import your component for non-owners
            ...
            <div className='DetaliedBook mt-5 normalFont'>
                <div className='DetaliedBook mt-5'>
                    <div className=''>
                        ...
                        <p className='text-secondary samll fst-normal'>View all Feedbacks below</p>
                        <hr></hr>
                    </div>
                    <ul className="nav nav-tabs mb-5 mt-5">
                        ...
                        <li className="nav-item">
                            <a className={`nav-link text-dark px-5 ${activeTab === 'parentFeedback' ? 'active' : ''}`} onClick={() => setActiveTab('parentFeedback')} href="#">
                                My Feedbacks
                            </a>
                        </li>
                        )}
                    ...
                    <div>
                        {activeTab === 'ViewFeedback' && ownerProfile && <BabysitterViewFeedback />}
                        {activeTab === 'ViewFeedback' && !ownerProfile && <NonOwnerFeedbackComponent id={id} />}
                        {activeTab === 'parentFeedback' && !ownerProfile && <ParentFeedback id={id} />}
