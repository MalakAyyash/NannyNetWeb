...
function ParentFeedback({ id }) {
    const [feedbackData, setFeedbackData] = useState(null); // State to store feedback data
    const [customerId, setCustomerId] = useState(null); // State to store customer ID from cookies
    ...
    useEffect(() => {
        const fetchFeedbackData = async () => {
            try {
                ...
                setCustomerId(userIdFromCookies);
    ...
    // Filter feedback data based on customer ID from cookies
    const filteredFeedbackData = feedbackData.filter(feedback => feedback.customer.user.id === parseInt(customerId));
