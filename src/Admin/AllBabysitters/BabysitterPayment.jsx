...
function BabysitterPayment({id}) {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`http://176.119.254.188:8080/admin/payments/employee/${id}`, config);
...
export default BabysitterPayment;
