  ...
  const columns = React.useMemo(
    () => [
      { Header: 'ID', accessor: 'user.id' },
      {
        ...
        accessor: 'user.name',
        Cell: ({ row }) => (
          <Link className='textRedColor' to={`/admin/CustomerInfoStatus/${row.original.user.id}`}>
      ...
      { Header: 'Tel Number', accessor: 'user.telNumber' },
      { Header: 'Gender', accessor: 'user.gender' },
      { Header: 'Date Added', accessor: 'user.dateAdded' },
